...
int main()
{
	...
	cv::Mat rgb1 = cv::imread("../data/rgb_png/6.png");
	cv::Mat rgb2 = cv::imread("../data/rgb_png/7.png");
	cv::Mat depth1 = cv::imread("../data/depth_png/6.png",-1);
	cv::Mat depth2 = cv::imread("../data/depth_png/7.png",-1);
	...
	//try{
	cv::imwrite("../data/keypoints.jpg",imgShow);//}
	...
	cv::imwrite("../data/matches.jpg", imgMatches);
	...
	cv::imwrite("../data/inliers.jpg", imgMatches);
	//cv::waitKey(0);
